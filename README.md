...
<ul>
  ...
  <li>If randoms still join while matchmaking off, please click Options->Edit Hosts File, it will pop up a text file, then check following codes in picture showed below look exactly same in that text file (find this code: "127.0.0.1 mm-gta5-prod.ros.rockstargames.com", and make sure there is no "#" in front of it)<br>
    <details>
