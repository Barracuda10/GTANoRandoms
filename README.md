...
[EXPERIMENTAL] This is a tool can create no randoms session<br>
<br>
<details>
  ...
  This tool can block that server that matching randoms into the session.<br>
...
<ul>
  ...
  <ul>
    <li>Usually it will join a friend, to avoid this enable <!--<a href="/README.md#firewall-solo-session">-->Firewall Solo Session<!--</a>-->, then find a new session, Remember to disable it later</li>
  </ul>
