...
<ul>
  ...
  <li>This program is based on network so it won't modified game play and game file.</li>
  <li>This program will not modified any other file except the one showed below.<br>
    <details>
